  ...
  return (
    <>
      ...
      <p className="intro">
        ...
        twarzy, a może nawet - jak to manekiny - bez życia. Nazwa to odniesienie do masowego powielania się wspomnianych zachowań oraz 
        ich wszechobecnego występowania, czyli uniformizacji.
      </p>
